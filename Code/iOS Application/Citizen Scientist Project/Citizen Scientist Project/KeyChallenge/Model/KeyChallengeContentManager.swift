...
class KeyChallengeContentManager {
    ...
    class func fetchContent() -> KeyChallengeContent {
        ...
        return KeyChallengeContent(
            ...
            viewKeyChallengeWinners: Link(text: "VIEW THE 2016-17 KEY CHALLENGE WINNERS", url: URL(string: "")!),
            headerLabel2: "WELCOME TO THE 2017-18 KEY CHALLENGE: HUMAN IMPACT",
            bodyText1: bodyText1,
            reefImageName1: "key-challenge-barnacle",
            bodyText2: bodyText2,
            ...
            learnMoreMiniChallenge: Link(text: "LEARN MORE", url: URL(string: "")!),
            headerLabel4: "THE 2017-18 PROGRAM",
            downloadKeyChallengeProgram: Link(text: "Download the 2017-18 Key Challenge program.", url: URL(string: "")!),
            issuuImageLink: ImageLink(imageName: "key-challenge-prezi", link: Link(url: URL(string: "")!)),
            headerLabel5: "KEY CHALLENGE REGISTRATION CAN ONLY BE COMPLETED ONLINE",
            learnMoreRegistration: Link(text: "LEARN MORE", url: URL(string: "")!),
