...
class WaterWatchContentManager {
    ...
    private static let DataMap: Dictionary<String, Any> = [
        ...
        "chorophyllA" : Link(text: "Chlorophyll a", url: URL(string: "http://sfyl.ifas.ufl.edu/miami-dade/")!),
    ]
